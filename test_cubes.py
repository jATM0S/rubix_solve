...
# rubiks_cube={'U1': 'O', 'U2': 'O', 'U3': 'G', 'U4': 'O', 'U5': 'Y', 'U6': 'R', 'U7': 'B', 'U8': 'R', 'U9': 'W', 'R1': 'G', 'R2': 'G', 'R3': 'R', 'R4': 'Y', 'R5': 'B', 'R6': 'O', 'R7': 'G', 'R8': 'B', 'R9': 'O', 'F1': 'W', 'F2': 'B', 'F3': 'O', 'F4': 'G', 'F5': 'O', 'F6': 'R', 'F7': 'R', 'F8': 'O', 'F9': 'Y', 'D1': 'B', 'D2': 'W', 'D3': 'R', 'D4': 'W', 'D5': 'W', 'D6': 'W', 'D7': 'R', 'D8': 'W', 'D9': 'Y', 'L1': 'Y', 'L2': 'G', 'L3': 'O', 'L4': 'B', 'L5': 'G', 'L6': 'Y', 'L7': 'B', 'L8': 'G', 'L9': 'Y', 'B1': 'W', 'B2': 'Y', 'B3': 'B', 'B4': 'B', 'B5': 'R', 'B6': 'Y', 'B7': 'G', 'B8': 'R', 'B9': 'W'}


# cubes with  uniform bottom
# rubiks_cube={'F1': 'R', 'F2': 'B', 'F3': 'R', 'F4': 'R', 'F5': 'R', 'F6': 'G', 'F7': 'R', 'F8': 'R', 'F9': 'R', 'R1': 'G', 'R2': 'Y', 'R3': 'O', 'R4': 'R', 'R5': 'G', 'R6': 'Y', 'R7': 'G', 'R8': 'G', 'R9': 'G', 'B1': 'Y', 'B2': 'O', 'B3': 'Y', 'B4': 'R', 'B5': 'O', 'B6': 'G', 'B7': 'O', 'B8': 'O', 'B9': 'O', 'L1': 'O', 'L2': 'Y', 'L3': 'B', 'L4': 'Y', 'L5': 'B', 'L6': 'B', 'L7': 'B', 'L8': 'B', 'L9': 'B', 'U1': 'B', 'U2': 'G', 'U3': 'G', 'U4': 'B', 'U5': 'Y', 'U6': 'O', 'U7': 'Y', 'U8': 'O', 'U9': 'Y', 'D1': 'W', 'D2': 'W', 'D3': 'W', 'D4': 'W', 'D5': 'W', 'D6': 'W', 'D7': 'W', 'D8': 'W', 'D9': 'W'}
# rubiks_cube={'U1': 'B', 'U2': 'Y', 'U3': 'Y', 'U4': 'O', 'U5': 'Y', 'U6': 'R', 'U7': 'Y', 'U8': 'Y', 'U9': 'R', 'R1': 'Y', 'R2': 'B', 'R3': 'B', 'R4': 'R', 'R5': 'B', 'R6': 'O', 'R7': 'B', 'R8': 'B', 'R9': 'B', 'F1': 'O', 'F2': 'B', 'F3': 'G', 'F4': 'G', 'F5': 'O', 'F6': 'G', 'F7': 'O', 'F8': 'O', 'F9': 'O', 'D1': 'W', 'D2': 'W', 'D3': 'W', 'D4': 'W', 'D5': 'W', 'D6': 'W', 'D7': 'W', 'D8': 'W', 'D9': 'W', 'L1': 'O', 'L2': 'G', 'L3': 'G', 'L4': 'Y', 'L5': 'G', 'L6': 'Y', 'L7': 'G', 'L8': 'G', 'L9': 'G', 'B1': 'R', 'B2': 'R', 'B3': 'Y', 'B4': 'B', 'B5': 'R', 'B6': 'O', 'B7': 'R', 'B8': 'R', 'B9': 'R'}
...
# rubiks_cube={'U1': 'Y', 'U2': 'G', 'U3': 'O', 'U4': 'Y', 'U5': 'Y', 'U6': 'Y', 'U7': 'B', 'U8': 'R', 'U9': 'G', 'R1': 'Y', 'R2': 'B', 'R3': 'B', 'R4': 'O', 'R5': 'O', 'R6': 'O', 'R7': 'O', 'R8': 'O', 'R9': 'O', 'F1': 'Y', 'F2': 'Y', 'F3': 'O', 'F4': 'G', 'F5': 'G', 'F6': 'G', 'F7': 'G', 'F8': 'G', 'F9': 'G', 'D1': 'W', 'D2': 'W', 'D3': 'W', 'D4': 'W', 'D5': 'W', 'D6': 'W', 'D7': 'W', 'D8': 'W', 'D9': 'W', 'L1': 'G', 'L2': 'O', 'L3': 'R', 'L4': 'R', 'L5': 'R', 'L6': 'R', 'L7': 'R', 'L8': 'R', 'L9': 'R', 'B1': 'Y', 'B2': 'Y', 'B3': 'R', 'B4': 'B', 'B5': 'B', 'B6': 'B', 'B7': 'B', 'B8': 'B', 'B9': 'B'}
# rubiks_cube={'F1': 'Y', 'F2': 'B', 'F3': 'W', 'F4': 'Y', 'F5': 'Y', 'F6': 'Y', 'F7': 'Y', 'F8': 'Y', 'F9': 'Y', 'R1': 'R', 'R2': 'Y', 'R3': 'O', 'R4': 'O', 'R5': 'O', 'R6': 'O', 'R7': 'O', 'R8': 'O', 'R9': 'O', 'B1': 'W', 'B2': 'B', 'B3': 'Y', 'B4': 'W', 'B5': 'W', 'B6': 'W', 'B7': 'W', 'B8': 'W', 'B9': 'W', 'L1': 'O', 'L2': 'R', 'L3': 'R', 'L4': 'R', 'L5': 'R', 'L6': 'R', 'L7': 'R', 'L8': 'R', 'L9': 'R', 'U1': 'B', 'U2': 'W', 'U3': 'B', 'U4': 'B', 'U5': 'B', 'U6': 'B', 'U7': 'B', 'U8': 'O', 'U9': 'B', 'D1': 'G', 'D2': 'G', 'D3': 'G', 'D4': 'G', 'D5': 'G', 'D6': 'G', 'D7': 'G', 'D8': 'G', 'D9': 'G'}


# CUBES WITH TOP CROSS
